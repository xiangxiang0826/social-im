...
func ProhibitionUserInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ProhibitionGetReq
		...
		l := room.NewProhibitionUserInfoLogic(r.Context(), svcCtx)
		resp, err := l.ProhibitionUserInfo(&req)
