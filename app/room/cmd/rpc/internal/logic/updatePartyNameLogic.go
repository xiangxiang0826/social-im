...
func (l *UpdatePartyNameLogic) UpdatePartyName(in *pb.PartyNameUpdateReq) (*pb.PartyNameUpdateResp, error) {
	...
	return &pb.PartyNameUpdateResp{Id: partyResp.Id, Mark: partyResp.Mark, Name: in.Name}, nil
}
