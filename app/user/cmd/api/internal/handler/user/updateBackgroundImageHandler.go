...
func UpdateBackgroundImageHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateBackgroundImageReq
		...
		l := user.NewUpdateBackgroundImageLogic(r.Context(), svcCtx)
		resp, err := l.UpdateBackgroundImage(&req)
